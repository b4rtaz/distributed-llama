...
transformer-block-test: src/transformer-block-test.cpp
	$(CC) -std=c++11 -Werror -O3 src/transformer-block-test.cpp -g -o transformer-block-test shared-buffer.o transformer.o matmul.o funcs.o

tokenizer: src/transformer.cpp
	$(CC) -std=c++11 -Werror -O3 -c src/tokenizer.cpp -g -o tokenizer.o

main: src/main.cpp
	$(CC) -std=c++11 -Werror -O3 src/main.cpp -g -o main shared-buffer.o transformer.o matmul.o funcs.o tokenizer.o
