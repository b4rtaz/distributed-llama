...
llamafile-sgemm: src/llamafile-sgemm.cpp
...
llama2-tasks-test: src/llama2-tasks-test.cpp utils quants llamafile-sgemm funcs socket transformer tasks llama2-tasks tokenizer
	$(CXX) $(CXXFLAGS) src/llama2-tasks-test.cpp -o llama2-tasks-test utils.o quants.o llamafile-sgemm.o funcs.o socket.o transformer.o tasks.o llama2-tasks.o tokenizer.o -lpthread
grok1-tasks-test: src/grok1-tasks-test.cpp utils quants llamafile-sgemm funcs socket transformer tasks llama2-tasks grok1-tasks tokenizer
	$(CXX) $(CXXFLAGS) src/grok1-tasks-test.cpp -o grok1-tasks-test utils.o quants.o llamafile-sgemm.o funcs.o socket.o transformer.o tasks.o llama2-tasks.o grok1-tasks.o tokenizer.o -lpthread
