...
main: src/main.cpp utils quants funcs socket transformer tasks grok1-tasks tokenizer
	$(CXX) $(CXXFLAGS) src/main.cpp -o main utils.o quants.o funcs.o socket.o transformer.o tasks.o grok1-tasks.o tokenizer.o -lpthread
...
grok1-tasks-test: src/grok1-tasks-test.cpp utils quants funcs socket transformer grok1-tasks tokenizer
	$(CXX) $(CXXFLAGS) src/grok1-tasks-test.cpp -o grok1-tasks-test utils.o quants.o funcs.o socket.o transformer.o tasks.o grok1-tasks.o tokenizer.o -lpthread
